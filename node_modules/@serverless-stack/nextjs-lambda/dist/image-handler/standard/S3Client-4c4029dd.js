...
var index = require('./index-23491200.js');
var Url = require('url');
...
var imageHandler = require('./image-handler-616ae4ea.js');
...
function cloneQuery(query) {
    return Object.keys(query).reduce(function (carry, paramName) {
        ...
        return index.__assign(index.__assign({}, carry), (_a = {}, _a[paramName] = Array.isArray(param) ? index.__spreadArray([], index.__read(param), false) : param, _a));
    }, {});
}
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (retryStrategy === null || retryStrategy === void 0 ? void 0 : retryStrategy.mode)
                            context.userAgent = index.__spreadArray(index.__spreadArray([], index.__read((context.userAgent || [])), false), [["cfg/retry-mode", retryStrategy.mode]], false);
    ...
    return function () { return index.__awaiter(void 0, void 0, void 0, function () {
        ...
        return index.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    appId = _a.sent();
                    resolvedUserAgent = appId ? index.__spreadArray(index.__spreadArray([], index.__read(sections), false), [["app/" + appId]], false) : index.__spreadArray([], index.__read(sections), false);
                    _a.label = 2;
            ...
            return index.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        sdkUserAgentValue = index.__spreadArray(index.__spreadArray(index.__spreadArray([], index.__read(defaultUserAgent), false), index.__read(userAgent), false), index.__read(customUserAgent), false).join(SPACE);
                        normalUAValue = index.__spreadArray(index.__spreadArray([], index.__read(defaultUserAgent.filter(function (section) { return section.startsWith("aws-sdk-"); })), false), index.__read(customUserAgent), false).join(SPACE);
...
var defaultProvider = function (init) {
    ...
    var providerChain = chain.apply(void 0, index.__spreadArray([], index.__read(providers), false));
...
function resolveBucketEndpointConfig(input) {
    ...
    return index.__assign(index.__assign({}, input), { bucketEndpoint: bucketEndpoint, forcePathStyle: forcePathStyle, useAccelerateEndpoint: useAccelerateEndpoint, useDualstackEndpoint: useDualstackEndpoint, useArnRegion: typeof useArnRegion === "function" ? useArnRegion : function () { return Promise.resolve(useArnRegion); } });
}
