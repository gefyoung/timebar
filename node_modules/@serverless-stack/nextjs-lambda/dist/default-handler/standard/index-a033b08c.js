...
var makePagedClientRequest$1 = function (client, input) {
    ...
    return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.send.apply(client, serdePlugin.__spreadArray([new ListDeadLetterSourceQueuesCommand(input)], serdePlugin.__read(args), false))];
                case 1: 
                // @ts-ignore
...
var makePagedRequest$1 = function (client, input) {
    ...
    return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.listDeadLetterSourceQueues.apply(client, serdePlugin.__spreadArray([input], serdePlugin.__read(args), false))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
        ...
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, serdePlugin.__await(makePagedRequest$1.apply(void 0, serdePlugin.__spreadArray([config.client, input], serdePlugin.__read(additionalArguments), false)))];
                case 2:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    if (!(config.client instanceof SQSClient)) return [3 /*break*/, 5];
                    return [4 /*yield*/, serdePlugin.__await(makePagedClientRequest$1.apply(void 0, serdePlugin.__spreadArray([config.client, input], serdePlugin.__read(additionalArguments), false)))];
                case 4:
                    page = _a.sent();
                    return [3 /*break*/, 6];
...
var makePagedClientRequest = function (client, input) {
    ...
    return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.send.apply(client, serdePlugin.__spreadArray([new ListQueuesCommand(input)], serdePlugin.__read(args), false))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
...
var makePagedRequest = function (client, input) {
    ...
    return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, client.listQueues.apply(client, serdePlugin.__spreadArray([input], serdePlugin.__read(args), false))];
                case 1: 
                // @ts-ignore
                return [2 /*return*/, _a.sent()];
            }
        ...
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    ...
                    input["MaxResults"] = config.pageSize;
                    if (!(config.client instanceof SQS)) return [3 /*break*/, 3];
                    return [4 /*yield*/, serdePlugin.__await(makePagedRequest.apply(void 0, serdePlugin.__spreadArray([config.client, input], serdePlugin.__read(additionalArguments), false)))];
                case 2:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 3:
                    if (!(config.client instanceof SQSClient)) return [3 /*break*/, 5];
                    return [4 /*yield*/, serdePlugin.__await(makePagedClientRequest.apply(void 0, serdePlugin.__spreadArray([config.client, input], serdePlugin.__read(additionalArguments), false)))];
                case 4:
                    page = _a.sent();
                    return [3 /*break*/, 6];
                case 5: throw new Error("Invalid client, expected SQS | SQSClient");
