...
var fs = require('fs');
require('http2');
var index = require('./index-9ffda90b.js');
require('url');
require('buffer');
require('http');
require('os');
...
function resolveBucketEndpointConfig(input) {
    ...
    return serdePlugin.__assign(serdePlugin.__assign({}, input), { bucketEndpoint: bucketEndpoint, forcePathStyle: forcePathStyle, useAccelerateEndpoint: useAccelerateEndpoint, useDualstackEndpoint: useDualstackEndpoint, useArnRegion: typeof useArnRegion === "function" ? useArnRegion : function () { return Promise.resolve(useArnRegion); } });
}
...
const getRuntimeConfig$1 = (config) => {
    ...
    return ({
        ...
        urlParser: (_f = config === null || config === void 0 ? void 0 : config.urlParser) !== null && _f !== void 0 ? _f : defaultRoleAssumers.parseUrl,
