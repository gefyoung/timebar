...
function cloneQuery(query) {
    return Object.keys(query).reduce(function (carry, paramName) {
        ...
        return serdePlugin.__assign(serdePlugin.__assign({}, carry), (_a = {}, _a[paramName] = Array.isArray(param) ? serdePlugin.__spreadArray([], serdePlugin.__read(param), false) : param, _a));
    }, {});
}
                ...
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        if (retryStrategy === null || retryStrategy === void 0 ? void 0 : retryStrategy.mode)
                            context.userAgent = serdePlugin.__spreadArray(serdePlugin.__spreadArray([], serdePlugin.__read((context.userAgent || [])), false), [["cfg/retry-mode", retryStrategy.mode]], false);
    ...
    return function () { return serdePlugin.__awaiter(void 0, void 0, void 0, function () {
        ...
        return serdePlugin.__generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    appId = _a.sent();
                    resolvedUserAgent = appId ? serdePlugin.__spreadArray(serdePlugin.__spreadArray([], serdePlugin.__read(sections), false), [["app/" + appId]], false) : serdePlugin.__spreadArray([], serdePlugin.__read(sections), false);
                    _a.label = 2;
            ...
            return serdePlugin.__generator(this, function (_c) {
                switch (_c.label) {
                    ...
                    case 1:
                        ...
                        sdkUserAgentValue = serdePlugin.__spreadArray(serdePlugin.__spreadArray(serdePlugin.__spreadArray([], serdePlugin.__read(defaultUserAgent), false), serdePlugin.__read(userAgent), false), serdePlugin.__read(customUserAgent), false).join(SPACE);
                        normalUAValue = serdePlugin.__spreadArray(serdePlugin.__spreadArray([], serdePlugin.__read(defaultUserAgent.filter(function (section) { return section.startsWith("aws-sdk-"); })), false), serdePlugin.__read(customUserAgent), false).join(SPACE);
...
var defaultProvider = function (init) {
    ...
    var providerChain = chain.apply(void 0, serdePlugin.__spreadArray([], serdePlugin.__read(providers), false));
